...
def main(): 
    ...
    try:
        ...
        controller = Controller(resolution=1/1, default_speed=1.0, delay=0.0)
        controller.add_motor("X", UnipolarStepperMotor(coils=(23, 24, 25, 8), max_position=9999, min_position=-9999, delay=0.02))
        controller.add_motor("Y", UnipolarStepperMotor(coils=(22, 10, 9, 11), max_position=9999, min_position=-9999, delay=0.02))
